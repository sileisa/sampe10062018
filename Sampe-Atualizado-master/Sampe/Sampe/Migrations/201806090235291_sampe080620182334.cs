namespace Sampe.Migrations
{
    ...
    public partial class sampe080620182334 : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        PesoDaPeca2 = c.Single(nullable: false),
                ...
                c => new
                    {
                        ...
                        Complemento = c.String(nullable: false, unicode: false),
                        Numero = c.Int(nullable: false),
                        Telefone = c.Int(nullable: false),
                        Email = c.String(nullable: false, unicode: false),
                        IE = c.Int(nullable: false),
                    })
        ...
        {
            DropForeignKey("dbo.Expedicaos", "CodigoIdentificadorKit", "dbo.OrdemProducaoKits");
            DropForeignKey("dbo.Expedicaos", "OrdemProducaoCopoId", "dbo.OrdemProducaoCopoes");
            DropForeignKey("dbo.Expedicaos", "MarcantiId", "dbo.Marcantis");
            DropForeignKey("dbo.Expedicaos", "ClienteId", "dbo.Clientes");
            ...
            DropIndex("dbo.Expedicaos", new[] { "OrdemProducaoCopoId" });
            DropIndex("dbo.Expedicaos", new[] { "CodigoIdentificadorKit" });
            DropIndex("dbo.Expedicaos", new[] { "MarcantiId" });
            DropIndex("dbo.Expedicaos", new[] { "ClienteId" });
