...
namespace Sampe.Controllers
{
    public class MarcantiController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MarcantiId,NomeEmpresa,Cnpj,Cep,Uf,Cidade,Rua,Bairro,Complemento,Numero,Telefone,Email,IE")] Marcanti marcanti)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MarcantiId,NomeEmpresa,Cnpj,Cep,Uf,Cidade,Rua,Bairro,Complemento,Numero,Telefone,Email,IE")] Marcanti marcanti)
        {
            if (ModelState.IsValid)
            {
